...
Value Eval::evaluate(const Eval::NNUE::Networks&    networks,
    ...
    Value nnue = networks.big.evaluate(pos, &caches.big, true, &nnueComplexity, false);
  
    //smallNet ? networks.small.evaluate(pos, nullptr, true, &nnueComplexity, psqtOnly)
    //Value nnue = networks.big.evaluate(pos, true, &nnueComplexity, psqtOnly);
